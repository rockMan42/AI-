...
def test_classification_uses_one_sdk_request_without_tools(monkeypatch, content, finish, valid):
    requests = []
    def respond(request):
    ...
    settings = SimpleNamespace(dashscope_api_key="test", intent_timeout_seconds=10)
    if valid:
